...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Update Service Information</h3>
                            ...
                            <form role="form" action="{{route('service.update',$service->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-12 p-0">
                                        ...
                                        <textarea class="form-control" name="text" rows="5">{{$service->text}}</textarea>
                                    </div>
                                    <div class="form-group col-lg-12 p-0">
                                        <label>
                                            @if ($errors->has('logo'))
                                        ...
                                        <input class="form-control" type="text"  name="logo"  value="{{$service->logo}}">
                                    </div>
