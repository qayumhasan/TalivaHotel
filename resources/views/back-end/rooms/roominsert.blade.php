...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Add Your Room</h3>
                            ...
                            <form role="form" action="{{route('room.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-12 p-0">
                                        ...
                                        <input class="form-control" type="text"  name="room_no" value="{{ old('room_no') }}" placeholder="Enter Your Room Number. EX. A-702">
                                    </div>
                                    <div class="form-group col-lg-12 p-0">
                                        <label>
                                        ...
                                        <input class="form-control" name="room_name" value="{{ old('room_name') }}"  placeholder="Enter Room Name..">
                                    </div>
                                    <div class="form-group col-lg-12 p-0">
                                        <label>
                                        ...
                                        <textarea class="form-control" name="room_desc" rows="5" placeholder="Write Your Room Description......">{{ old('room_desc') }}</textarea>
                                    </div>
                                    <div class="form-group col-lg-4 p-0">
                                        ...
                                        <input class="form-control" type="number" name="room_price" value="{{ old('room_price') }}" placeholder="Enter Room Price..">
                                    </div>
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input class="form-control" type="number" name="room_size"  value="{{ old('room_size') }}" placeholder="Enter Room Size..">
                                    </div>
                                    <div class="form-group col-lg-4 p-0">
                                        <label>
                                        ...
                                        <input class="form-control" type="number" name="room_guest"  value="{{ old('room_guest') }}" placeholder="Enter Number of Guest..">
                                    </div>
