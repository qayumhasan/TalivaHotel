                ...
                <div class="col-lg-6">
                    ...
                    <div class="payment-details pt-3">
                        <ul class="nav p-2">
                            ...
                            <li class="pull-right">{{$guestinfo->roominfo->room_name}}</li>
                        </ul>
                        <ul class="nav p-2">
                            <li class="pr-4"><strong>Arrival Date:</strong></li>
                            <li class="pull-right">{{$guestinfo->bookingdatas->arrival}}</li>
                        </ul>
                        <ul class="nav p-2">
                            <li class="pr-4"><strong>Depature Date:</strong></li>
                            <li class="pull-right">{{$guestinfo->bookingdatas->departure}}</li>
                        </ul>
                        <ul class="nav p-2">
                            <li class="pr-4"><strong>Number Of Guest:</strong></li>
                            <li class="pull-right">{{$guestinfo->bookingdatas->guest_no}} Person</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
