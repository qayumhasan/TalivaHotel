        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Update Your Testimonial Information here
                </div>
                            ...
                            <form role="form" action="{{route('testimonial.update',$testimonial->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-12 p-0">
                                        ...
                                        <input class="form-control" type="text"  name="user" value="{{ $testimonial->user}}">
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12 p-0">
                                        ...
                                        <textarea class="form-control" name="testimonial" rows="3">{{ $testimonial->testimonial}}</textarea>
                                    </div>

                                    <div class="form-group col-lg-12 p-0">
                                        <label>
                                            <img src="{{asset('back-end/images/testimonial/')}}/{{$testimonial->image}}" alt="{{$testimonial->image}}" width="400px;">
                                        </label>
                                        <br>
                                        <label>
                                            @if ($errors->has('image'))
