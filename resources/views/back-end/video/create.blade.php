...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Add Video</h3>
                            ...
                            <form role="form" action="{{route('video.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-12 p-0">
                                        ...
                                        <input class="form-control" type="text"  name="title" value="{{ old('title') }}" placeholder="Enter video Title Here...">
                                    </div>
                                    ...
                                    <div class="form-group col-lg-12 p-0">
                                        ...
                                        <input class="form-control" type="text"  name="video" value="{{ old('video') }}" placeholder="Enter video Link Here... ">
                                    </div>
                                    <div class="form-group col-lg-12 p-0">
                                        <label>
                                            @if ($errors->has('image'))
