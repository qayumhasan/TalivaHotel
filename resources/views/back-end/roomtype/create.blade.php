        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" action="{{route('roomtype.store')}}" method="post">
                                @csrf
                                <div class="form-row">
                                    <div class="form-group col-lg-12 p-0">
                                        ...
                                        <input class="form-control" type="text"  name="room_type" value="{{ old('room_type') }}" placeholder="Enter Room Type Here...">
                                    </div>
                                    <div class="form-group col-lg-12 p-0">
                                        <label>
